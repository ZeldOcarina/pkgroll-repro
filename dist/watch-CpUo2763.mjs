...
import { c as createFilter, r as rollupInternal, g as getAugmentedNamespace, p as picomatch$2, f as fseventsImporter } from './rollup-ugRghNWe.mjs';
    ...
    constructor(watcher, options) {
        ...
        this.outputFiles = this.outputs.map(output => {
            if (output.file || output.dir)
                return path$n.resolve(output.file || output.dir);
            return undefined;
        });

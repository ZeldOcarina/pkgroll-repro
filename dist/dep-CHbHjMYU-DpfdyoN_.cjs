...
const __filename$1 = node_url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('dep-CHbHjMYU-DpfdyoN_.cjs', document.baseURI).href)));
path$n.dirname(__filename$1);
const require$1 = node_module.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('dep-CHbHjMYU-DpfdyoN_.cjs', document.baseURI).href)));
...
var index = /*@__PURE__*/index$2.getDefaultExportFromCjs(postcssImport);

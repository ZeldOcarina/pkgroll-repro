import { e as error, L as LOGLEVEL_INFO, l as logPluginError, d as logLevelPriority, f as LOGLEVEL_WARN, h as logInvalidLogPosition, i as logInvalidFunctionPluginHook, j as logImplicitDependantIsNotIncluded, k as logCircularDependency, m as logMissingExport, E as EMPTY_ARRAY, n as logInvalidOption, o as logInvalidExportOptionValue, w as warnDeprecation, U as URL_OUTPUT_INTEROP, p as isValidUrl, q as addTrailingSlashIfMissed, r as URL_OUTPUT_SOURCEMAPBASEURL, s as logAlreadyClosed, t as LOGLEVEL_DEBUG, u as logMissingFileOrDirOption, v as logCannotEmitFromOptionsHook, x as relativeId, V as VariableDeclarator$1, y as ExportDefaultDeclaration$1, z as ExpressionStatement$1, A as logSyntheticNamedExportsNeedNamespaceExport, B as EMPTY_OBJECT, C as logMissingEntryExport, D as logInvalidFormatForTopLevelAwait, F as parseAsync_1, T as TemplateLiteral$1, G as Literal$1, H as logDuplicateExportError, I as logRedeclarationError, J as locate, K as logInvalidSourcemapForError, M as augmentCodeLocation, N as logInconsistentImportAttributes, O as logNamespaceConflict, P as logAmbiguousExternalNamespaces, Q as logShimmedExport, R as parseAst, S as logModuleParseError, W as logChunkInvalid, X as URL_OUTPUT_FORMAT, Y as URL_OUTPUT_DIR, Z as URL_OUTPUT_SOURCEMAPFILE, _ as URL_OUTPUT_AMD_ID, $ as isAbsolute, a0 as logCannotAssignModuleToChunk, a1 as LOGLEVEL_ERROR, a2 as logUnknownOption, a3 as printQuotedStringList, a4 as logBadLoader, a5 as logExternalModulesCannotBeTransformedToModules, a6 as logInternalIdCannotBeExternal, a7 as isRelative, a8 as logUnresolvedImport, a9 as logUnresolvedImportTreatedAsExternal, aa as logExternalSyntheticExports, ab as logUnresolvedEntry, ac as logUnresolvedImplicitDependant, ad as logExternalModulesCannotBeIncludedInManualChunks, ae as logEntryCannotBeExternal, af as logImplicitDependantCannotBeExternal, ag as logInputHookInOutputPlugin, ah as logInvalidAddonPluginHook, ai as augmentLogMessage, aj as EMPTY_SET, ak as URL_TREESHAKE, al as URL_TREESHAKE_MODULESIDEEFFECTS, am as URL_OUTPUT_INLINEDYNAMICIMPORTS, an as URL_PRESERVEENTRYSIGNATURES, ao as URL_OUTPUT_AMD_BASEPATH, ap as URL_OUTPUT_EXTERNALIMPORTATTRIBUTES, aq as URL_OUTPUT_GENERATEDCODE, ar as URL_OUTPUT_MANUALCHUNKS, as as URL_WATCH, at as normalize, au as getImportPath, av as CallExpression$1, aw as logUnusedExternalImports, ax as ANNOTATION_KEY, ay as INVALID_ANNOTATION_KEY, az as BLANK, aA as logIllegalImportReassignment, aB as logDuplicateArgumentNameError, aC as ReturnStatement$1, aD as getAstBuffer, aE as logImportAttributeIsInvalid, aF as logImportOptionsAreInvalid, aG as logCircularReexport, aH as logFailedValidation, aI as logCyclicCrossChunkReexport, aJ as getAliasName, aK as logUnexpectedNamedImport, aL as relative$1, aM as logUnexpectedNamespaceReexport, aN as logEmptyChunk, aO as logOptimizeChunkStatus, aP as logInvalidSetAssetSourceCall, aQ as logNoAssetSourceSet, aR as logFileReferenceIdNotFoundForFilename, aS as logAssetReferenceIdNotFoundForSetSource, aT as logAssetSourceAlreadySet, aU as logInvalidRollupPhaseForChunkEmission, aV as isPathFragment, aW as Program$1, aX as CatchClause$1, aY as logModuleLevelDirective, aZ as Property$1, a_ as logConstVariableReassignError, a$ as ArrowFunctionExpression$1, b0 as logCannotCallNamespace, b1 as logEval, b2 as getRollupError, b3 as logParseError, b4 as logFirstSideEffect, b5 as logInvalidAnnotation, b6 as Identifier$1, b7 as logThisIsUndefined, b8 as convertAnnotations, b9 as FIXED_STRINGS, ba as convertNode$1, bb as logAddonNotGenerated, bc as logIncompatibleExportOptionValue, bd as logMixedExport, be as logMissingGlobalName, bf as xxhashBase64Url_1, bg as logNoTransformMapOrAstWithoutCode, bh as logFileNameConflict, bi as logAssetNotFinalisedForFileName, bj as logChunkNotGeneratedForFileName, bk as StaticBlock$1, bl as BlockStatement$1, bm as logIllegalIdentifierAsName, bn as logMissingNameOptionForIifeExport, bo as logMissingNameOptionForUmdExport, bp as xxhashBase36_1, bq as xxhashBase16_1, br as logAnonymousPluginCache, bs as logDuplicatePluginName, bt as logMissingNodeBuiltins, bu as logConflictingSourcemapSources, bv as logSourcemapBroken } from './index-mCKZ_gj6.mjs';
import { resolve, dirname, basename, extname, relative } from 'node:path';
import require$$0$4, { win32, posix, isAbsolute as isAbsolute$1, resolve as resolve$1 } from 'path';
...
import * as require$$0$3 from 'tty';
...
function getMatcherString(id, resolutionBase) {
    ...
    const basePath = normalizePath(resolve$1(''))
...
const isCompatibleTerminal =
  require$$0$3 && require$$0$3.isatty && require$$0$3.isatty(1) && env.TERM && !isDumbTerminal;
...
async function watchInternal(configs, emitter) {
    ...
    await loadFsEvents();
    const { Watcher } = await import('./watch-CpUo2763.mjs');
...
export { rollup as a, createFilter as c, fseventsImporter as f, getAugmentedNamespace as g, picomatch as p, rollupInternal as r };

...
var index$2 = require('./index-Bqh2AaI-.cjs');
var require$$0__default = require('fs');
var postcss$1 = require('./postcss-ySjLxSRq.cjs');
var require$$0$4 = require('path');
var require$$3$1 = require('crypto');
var require$$0$5 = require('util');
var depIQSZa7F = require('./dep-IQS-Za7F-BbeLljYA.cjs');
...
const __filename$1 = node_url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('dep-B8yndt7W-C4rO_7q7.cjs', document.baseURI).href)));
path$n.dirname(__filename$1);
const require$1 = node_module.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('dep-B8yndt7W-C4rO_7q7.cjs', document.baseURI).href)));
...
var freeGlobal = typeof index$2.commonjsGlobal == 'object' && index$2.commonjsGlobal && index$2.commonjsGlobal.Object === Object && index$2.commonjsGlobal;
...
var _postcss$1 = _interopRequireDefault$4(postcss$1.default);
...
class FileSystemLoader {
  ...
  async fetch(_newPath, relativeTo, _trace) {
    ...
    if (!useFileResolve && newPath[0] !== "." && !_path.default.isAbsolute(newPath)) {
      try {
        fileRelativePath = require$1.resolve(newPath);
      } catch (e) {// noop
      }
    }
...
var node = require$$0$5.deprecate;
...
const valueParser = depIQSZa7F.lib;
...
var _postcss = _interopRequireDefault(postcss$1.default);
...
var index = /*@__PURE__*/index$2.getDefaultExportFromCjs(buildExports);
